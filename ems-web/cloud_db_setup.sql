CREATE DATABASE ems_demo;
-- then import the .sql into ems_demo (use Workbench or command line)
use ems_demo;
-- ============================================
...
CREATE USER 'ems_web'@'localhost' IDENTIFIED BY 'Demo@123';
GRANT SELECT, INSERT, UPDATE ON ems_demo.* TO 'ems_web'@'localhost';
FLUSH PRIVILEGES;
